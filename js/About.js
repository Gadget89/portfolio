    ...
    return (
      <section className="center_wrapper">
        ...
        <span className="sub_title">Front-End Developer | San Antonio, TX</span>
          ...
          <p className="profile_txt">
            I would like to join a great team and be involved in projects that I can be proud of. I invite you to check out my projects and if you are interested in helping make this happen, please feel free to <a className = "myContactInfo" href="mailto:nicolas.roybal@hotmail.com" data-rel="external">contact me.</a>
          </p>
      </section>
    )
  }
